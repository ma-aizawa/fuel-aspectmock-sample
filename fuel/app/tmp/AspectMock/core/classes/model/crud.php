...
class Model_Crud extends \Model implements \Iterator, \ArrayAccess, \Serializable, \Sanitization
{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($column, $value, $operator), true)) !== __AM_CONTINUE__) return $__am_res; 
		$config = array(
			'limit' => 1,
		);
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($column, $value, $operator, $limit, $offset), true)) !== __AM_CONTINUE__) return $__am_res; 
		$config = array(
			'limit' => $limit,
			'offset' => $offset,
		);
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($limit, $offset), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($config, $key), true)) !== __AM_CONTINUE__) return $__am_res; 
		$query = \DB::select()
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($column, $distinct, $where, $group_by), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($name, $args), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($writable), true)) !== __AM_CONTINUE__) return $__am_res; 
	 ...
	 * @return  void
	 */
	protected static function pre_find(&$query){ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array(&$query), true)) !== __AM_CONTINUE__) return $__am_res; }
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($result), true)) !== __AM_CONTINUE__) return $__am_res; 
		return $result;
	}
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($validate), false)) !== __AM_CONTINUE__) return $__am_res; 
		if ($this->frozen())
		{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($new), false)) !== __AM_CONTINUE__) return $__am_res; 
		if ($new === null)
		{
			return $this->_is_new;
		}
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($frozen), false)) !== __AM_CONTINUE__) return $__am_res; 
		if ($frozen === null)
		{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($vars), false)) !== __AM_CONTINUE__) return $__am_res; 
		if ( ! isset(static::$_rules) or count(static::$_rules) < 0)
		{
			return true;
		}
	 ...
	 * @return  void
	 */
	protected function pre_save(&$query){ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array(&$query), false)) !== __AM_CONTINUE__) return $__am_res; }
	 ...
	 * @return  void
	 */
	protected function pre_update(&$query){ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array(&$query), false)) !== __AM_CONTINUE__) return $__am_res; }
	 ...
	 * @return  void
	 */
	protected function pre_delete(&$query){ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array(&$query), false)) !== __AM_CONTINUE__) return $__am_res; }
